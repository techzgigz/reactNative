...
const EditDescriptionModal = ({ navigation, value, visible, setVisible }) => {
    const [updatedValue, setUpdatedValue] = useState(value);
    const handleUpdate = () => {
        (async () => {
            const updateResonse = await UpdateUserDetails({briefDescription: updatedValue, operationType: "update"})
            ...
            <ScrollView>
                <View style={styles.modalWrapper}>
                    ...
                    <View style={styles.headerWrapper}>
                        ...
                        <View><Text style={styles.heading}>Edit Description</Text></View>
                    </View>
