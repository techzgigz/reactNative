...
const AddEducation = ({ route, navigation }) => {
  ...
  const [formValues, setFormValues] = useState([
    {
      institute: education && education.institute ? education.institute : '',
      ...
      grades: education && education.grades ? education.grades : '',
      ...
      >
        {formValues.map((element, index) => (
          <>
            ...
            <TextInput
              value={formValues[0].institute}
              onChangeText={e => handleChange('institute', index, e)}
              placeholder="Enter Add University/School *"
            ...
            <View
              ...
              <Dropdown
                ...
                value={formValues[0].degree}
                onChange={item => {
                  handleChange('degree', index, item.value);
                }}
              />
            </View>
            <Text
